...
/* MIPI PHY Macros */
        #define MIPI_PHY_CLKSTPT   ((uint16_t)1167.181818181818)
        #define MIPI_PHY_CLKBFHT   ((uint8_t)11 + 1)
        #define MIPI_PHY_CLKKPT    ((uint8_t)23 + 4)
        #define MIPI_PHY_GOLPBKT   ((uint16_t)44)
        ...
        {
            .pll_settings = /* Calculated MIPI PHY PLL frequency: 1100000000 Hz (error 0.00%) = (24000000 Hz / 3) * 137.50 / 1 */{.div      = 3 - 1,.pll_div  = 0, .mul_int  = 137 - 1,.mul_frac = 3 /* Value: 0.5 */},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_extended_cfg_t g_mipi_dsi0_extended_cfg =
        {
            ...
            .dsi_plie               =  0x0,
            .dsi_vmie               = R_MIPI_DSI_VMIER_START_Msk | R_MIPI_DSI_VMIER_STOP_Msk | R_MIPI_DSI_VMIER_VIRDY_Msk | R_MIPI_DSI_VMIER_TIMERR_Msk | R_MIPI_DSI_VMIER_VBUFUDF_Msk | R_MIPI_DSI_VMIER_VBUFOVF_Msk |  0x0,
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .vertical_active_lines    = 640,
            .vertical_sync_lines      = 4,
            .vertical_back_porch      = (20 - 4),
            .vertical_front_porch     = (684 - 640 - 20 - 4),
            ...
            .horizontal_back_porch    = (30 - 10),
            .horizontal_front_porch   = (550 - 480 - 30 - 10),
            .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

            .video_mode_delay         = 271 /* This value was calculated by FSP. An override is available but not recommended for most users */,
...
/* Display Driver Frame Buffer 0 Configuration */
            ...
            #endif
                .p_framebuffer_0 = LVGL_FRAMEBUFFER_0,
                .p_framebuffer_1 = LVGL_FRAMEBUFFER_1,
                .p_callback      = NULL,
            };
